...
#keytool -importkeystore -srckeystore  kafka.broker2.truststore.jks  -destkeystore kafka.broker2.p12 -srcstoretype jks -deststoretype pkcs12
#openssl pkcs12 -in kafka.broker2.p12 -out kafka.broker2.pem
